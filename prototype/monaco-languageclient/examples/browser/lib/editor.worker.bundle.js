...
/* harmony export (immutable) */ __webpack_exports__["b"] = stringHash;
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_uint__ = __webpack_require__(97);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var PrefixSumComputer = /** @class */ (function () {
    ...
    PrefixSumComputer.prototype.removeValues = function (startIndex, cnt) {
        ...
        cnt = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint__["a" /* toUint32 */])(cnt);
        var oldValues = this.values;
        var oldPrefixSum = this.prefixSum;
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(53), __webpack_require__(54)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__promise_polyfill_polyfill__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__promise_polyfill_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__promise_polyfill_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_cancellation__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_common_event__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_common_keyCodes__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_common_uri__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_position__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_range__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_selection__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__core_token__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__standaloneEnums__ = __webpack_require__(108);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var KeyMod = /** @class */ (function () {
    ...
    KeyMod.chord = function (firstPart, secondPart) {
        return Object(__WEBPACK_IMPORTED_MODULE_3__base_common_keyCodes__["a" /* KeyChord */])(firstPart, secondPart);
    };
...
function createMonacoBaseAPI() {
    return {
        editor: undefined,
        languages: undefined,
        CancellationTokenSource: __WEBPACK_IMPORTED_MODULE_1__base_common_cancellation__["b" /* CancellationTokenSource */],
        Emitter: __WEBPACK_IMPORTED_MODULE_2__base_common_event__["a" /* Emitter */],
        KeyCode: __WEBPACK_IMPORTED_MODULE_9__standaloneEnums__["o" /* KeyCode */],
        KeyMod: KeyMod,
        Position: __WEBPACK_IMPORTED_MODULE_5__core_position__["a" /* Position */],
        Range: __WEBPACK_IMPORTED_MODULE_6__core_range__["a" /* Range */],
        Selection: __WEBPACK_IMPORTED_MODULE_7__core_selection__["a" /* Selection */],
        SelectionDirection: __WEBPACK_IMPORTED_MODULE_9__standaloneEnums__["z" /* SelectionDirection */],
        MarkerSeverity: __WEBPACK_IMPORTED_MODULE_9__standaloneEnums__["p" /* MarkerSeverity */],
        MarkerTag: __WEBPACK_IMPORTED_MODULE_9__standaloneEnums__["q" /* MarkerTag */],
        Uri: __WEBPACK_IMPORTED_MODULE_4__base_common_uri__["a" /* URI */],
        Token: __WEBPACK_IMPORTED_MODULE_8__core_token__["a" /* Token */]
    };
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__types__ = __webpack_require__(19);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function logOnceWebWorkerWarning(err) {
    if (!__WEBPACK_IMPORTED_MODULE_2__platform__["g" /* isWeb */]) {
        // running tests
        return;
    }
...
var SimpleWorkerClient = /** @class */ (function (_super) {
    ...
    function SimpleWorkerClient(workerFactory, moduleId, host) {
        ...
        var hostMethods = __WEBPACK_IMPORTED_MODULE_3__types__["c" /* getAllMethodNames */](host);
        ...
        _this._lazyProxy = new Promise(function (resolve, reject) {
            ...
            _this._onModuleLoaded.then(function (availableMethods) {
                resolve(__WEBPACK_IMPORTED_MODULE_3__types__["b" /* createProxyObject */](availableMethods, proxyMethodRequest));
            }, function (e) {
                reject(e);
...
var SimpleWorkerServer = /** @class */ (function () {
    ...
    SimpleWorkerServer.prototype.initialize = function (workerId, loaderConfig, moduleId, hostMethods) {
        ...
        var hostProxy = __WEBPACK_IMPORTED_MODULE_3__types__["b" /* createProxyObject */](hostMethods, proxyMethodRequest);
        if (this._requestHandlerFactory) {
            // static request handler
            this._requestHandler = this._requestHandlerFactory(hostProxy);
            return Promise.resolve(__WEBPACK_IMPORTED_MODULE_3__types__["c" /* getAllMethodNames */](this._requestHandler));
        }
        if (loaderConfig) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            self.require([moduleId], function (module) {
                ...
                resolve(__WEBPACK_IMPORTED_MODULE_3__types__["c" /* getAllMethodNames */](_this._requestHandler));
            }, reject);
        });
    };
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(137).setImmediate, __webpack_require__(54)))
...
/* unused harmony export create */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_arrays__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_diff_diff__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_common_iterator__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_common_platform__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_common_uri__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_position__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_range__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__diff_diffComputer__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__model_mirrorTextModel__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__model_wordHelper__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__modes_linkComputer__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__modes_supports_inplaceReplaceSupport__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__standalone_standaloneBase__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__base_common_types__ = __webpack_require__(19);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var MirrorModel = /** @class */ (function (_super) {
    ...
    MirrorModel.prototype.getWordAtPosition = function (position, wordDefinition) {
        ...
        if (wordAtText) {
            return new __WEBPACK_IMPORTED_MODULE_6__core_range__["a" /* Range */](position.lineNumber, wordAtText.startColumn, position.lineNumber, wordAtText.endColumn);
        }
        return null;
    };
    MirrorModel.prototype.createWordIterator = function (wordDefinition) {
        ...
        var next = function () {
            if (wordRangesIdx < wordRanges.length) {
                ...
                return __WEBPACK_IMPORTED_MODULE_2__base_common_iterator__["c" /* FIN */];
            }
            else {
    ...
    return MirrorModel;
}(__WEBPACK_IMPORTED_MODULE_8__model_mirrorTextModel__["a" /* MirrorTextModel */]));
/**
 * @internal
 */
var EditorSimpleWorker = /** @class */ (function () {
    ...
    EditorSimpleWorker.prototype.acceptNewModel = function (data) {
        this._models[data.url] = new MirrorModel(__WEBPACK_IMPORTED_MODULE_4__base_common_uri__["a" /* URI */].parse(data.url), data.lines, data.EOL, data.versionId);
    };
    ...
    EditorSimpleWorker.prototype.computeDiff = function (originalUrl, modifiedUrl, ignoreTrimWhitespace, maxComputationTime) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                diffComputer = new __WEBPACK_IMPORTED_MODULE_7__diff_diffComputer__["a" /* DiffComputer */](originalLines, modifiedLines, {
    ...
    EditorSimpleWorker.prototype.computeMoreMinimalEdits = function (modelUrl, edits) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                result = [];
                lastEol = undefined;
                edits = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_arrays__["r" /* mergeSort */])(edits, function (a, b) {
                    if (a.range && b.range) {
                        return __WEBPACK_IMPORTED_MODULE_6__core_range__["a" /* Range */].compareRangesUsingStarts(a.range, b.range);
                    }
                ...
                for (_i = 0, edits_1 = edits; _i < edits_1.length; _i++) {
                    ...
                    if (__WEBPACK_IMPORTED_MODULE_6__core_range__["a" /* Range */].isEmpty(range) && !text) {
                        // empty change
                        continue;
                    }
                    ...
                    changes = Object(__WEBPACK_IMPORTED_MODULE_1__base_common_diff_diff__["b" /* stringDiff */])(original, text, false);
                    editOffset = model.offsetAt(__WEBPACK_IMPORTED_MODULE_6__core_range__["a" /* Range */].lift(range).getStartPosition());
    ...
    EditorSimpleWorker.prototype.computeLinks = function (modelUrl) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Object(__WEBPACK_IMPORTED_MODULE_10__modes_linkComputer__["a" /* computeLinks */])(model)];
            });
        });
    };
    ...
    EditorSimpleWorker.prototype.navigateValueSet = function (modelUrl, range, up, wordDef, wordDefFlags) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                result = __WEBPACK_IMPORTED_MODULE_11__modes_supports_inplaceReplaceSupport__["a" /* BasicInplaceReplace */].INSTANCE.navigateValueSet(range, selectionText, wordRange, word, up);
                return [2 /*return*/, result];
            });
        });
    };
    ...
    EditorSimpleWorker.prototype.loadForeignModule = function (moduleId, createData, foreignHostMethods) {
        ...
        var foreignHost = __WEBPACK_IMPORTED_MODULE_13__base_common_types__["b" /* createProxyObject */](foreignHostMethods, proxyMethodRequest);
        var ctx = {
            host: foreignHost,
        ...
        if (this._foreignModuleFactory) {
            ...
            return Promise.resolve(__WEBPACK_IMPORTED_MODULE_13__base_common_types__["c" /* getAllMethodNames */](this._foreignModule));
        }
        // ESM-comment-begin
...
if (typeof importScripts === 'function') {
    ...
    __WEBPACK_IMPORTED_MODULE_3__base_common_platform__["b" /* globals */].monaco = Object(__WEBPACK_IMPORTED_MODULE_12__standalone_standaloneBase__["a" /* createMonacoBaseAPI */])();
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_diff_diff__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_strings__ = __webpack_require__(3);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function getFirstNonBlankColumn(txt, defaultValue) {
    var r = __WEBPACK_IMPORTED_MODULE_1__base_common_strings__["q" /* firstNonWhitespaceIndex */](txt);
    if (r === -1) {
        return defaultValue;
    }
    return r + 1;
...
function getLastNonBlankColumn(txt, defaultValue) {
    var r = __WEBPACK_IMPORTED_MODULE_1__base_common_strings__["D" /* lastNonWhitespaceIndex */](txt);
    if (r === -1) {
        return defaultValue;
    }
    return r + 2;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_position__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__viewModel_prefixSumComputer__ = __webpack_require__(117);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var MirrorTextModel = /** @class */ (function () {
    ...
    MirrorTextModel.prototype.onEvents = function (e) {
        ...
        for (var _i = 0, changes_1 = changes; _i < changes_1.length; _i++) {
            ...
            this._acceptInsertText(new __WEBPACK_IMPORTED_MODULE_0__core_position__["a" /* Position */](change.range.startLineNumber, change.range.startColumn), change.text);
        }
    ...
    MirrorTextModel.prototype._ensureLineStarts = function () {
        if (!this._lineStarts) {
            ...
            this._lineStarts = new __WEBPACK_IMPORTED_MODULE_1__viewModel_prefixSumComputer__["a" /* PrefixSumComputer */](lineStartValues);
        }
    };
    /**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_characterClassifier__ = __webpack_require__(66);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errors__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functional__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lifecycle__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__linkedList__ = __webpack_require__(65);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var Event;
(function (Event) {
    Event.None = function () { return __WEBPACK_IMPORTED_MODULE_2__lifecycle__["a" /* Disposable */].None; };
    /**
    ...
    function any() {
        ...
        return function (listener, thisArgs, disposables) {
            if (thisArgs === void 0) { thisArgs = null; }
            return __WEBPACK_IMPORTED_MODULE_2__lifecycle__["e" /* combinedDisposable */].apply(void 0, events.map(function (event) { return event(function (e) { return listener.call(thisArgs, e); }, null, disposables); }));
        };
    }
    Event.any = any;
    /**
        ...
        get: function () {
            ...
            if (!this._event) {
                this._event = function (listener, thisArgs, disposables) {
                    ...
                    if (disposables instanceof __WEBPACK_IMPORTED_MODULE_2__lifecycle__["b" /* DisposableStore */]) {
    ...
    Emitter.prototype.fire = function (event) {
        if (this._listeners) {
            ...
            if (!this._deliveryQueue) {
                this._deliveryQueue = new __WEBPACK_IMPORTED_MODULE_3__linkedList__["a" /* LinkedList */]();
            }
...
var PauseableEmitter = /** @class */ (function (_super) {
    ...
    function PauseableEmitter(options) {
        ...
        _this._isPaused = 0;
        _this._eventQueue = new __WEBPACK_IMPORTED_MODULE_3__linkedList__["a" /* LinkedList */]();
...
var EventMultiplexer = /** @class */ (function () {
    ...
    EventMultiplexer.prototype.add = function (event) {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_2__lifecycle__["h" /* toDisposable */])(Object(__WEBPACK_IMPORTED_MODULE_1__functional__["a" /* once */])(dispose));
    };
...
var Relay = /** @class */ (function () {
    function Relay() {
        ...
        this.inputEventListener = __WEBPACK_IMPORTED_MODULE_2__lifecycle__["a" /* Disposable */].None;
        this.emitter = new Emitter({
            onFirstListenerDidAdd: function () {
...
var Selection = /** @class */ (function (_super) {
    ...
    return Selection;
}(__WEBPACK_IMPORTED_MODULE_1__range__["a" /* Range */]));
...
var URI = /** @class */ (function () {
    ...
    URI.file = function (path) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__platform__["h" /* isWindows */]) {
...
var _pathSepMarker = __WEBPACK_IMPORTED_MODULE_0__platform__["h" /* isWindows */] ? 1 : undefined;
...
var ChordKeybinding = /** @class */ (function () {
    function ChordKeybinding(parts) {
        if (parts.length === 0) {
            throw Object(__WEBPACK_IMPORTED_MODULE_0__errors__["b" /* illegalArgument */])("parts");
        }
        this.parts = parts;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__iterator__ = __webpack_require__(44);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
        ...
        return {
            next: function () {
                if (node === Node.Undefined) {
                    return __WEBPACK_IMPORTED_MODULE_0__iterator__["c" /* FIN */];
                }
                if (!element) {
...
var CharacterClassifier = /** @class */ (function () {
    function CharacterClassifier(_defaultValue) {
        var defaultValue = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint__["b" /* toUint8 */])(_defaultValue);
    ...
    CharacterClassifier.prototype.set = function (charCode, _value) {
        var value = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint__["b" /* toUint8 */])(_value);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_worker_simpleWorker__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_services_editorSimpleWorker__ = __webpack_require__(190);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function initialize(foreignModule) {
    ...
    initialized = true;
    var simpleWorker = new __WEBPACK_IMPORTED_MODULE_0__base_common_worker_simpleWorker__["b" /* SimpleWorkerServer */](function (msg) {
        self.postMessage(msg);
    }, function (host) { return new __WEBPACK_IMPORTED_MODULE_1__common_services_editorSimpleWorker__["a" /* EditorSimpleWorker */](host, foreignModule); });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__diffChange__ = __webpack_require__(187);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hash__ = __webpack_require__(104);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    LcsDiff._getElements = function (sequence) {
        ...
        if (LcsDiff._isStringArray(elements)) {
            ...
            for (var i = 0, len = elements.length; i < len; i++) {
                hashes[i] = Object(__WEBPACK_IMPORTED_MODULE_1__hash__["b" /* stringHash */])(elements[i], 0);
            }
